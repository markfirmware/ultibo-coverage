...
{==============================================================================}
{Global definitions}
{$INCLUDE \root\ultibo\core\fpc\source\rtl\ultibo\core\GlobalDefines.inc}
...
initialization
 QEMUVPB_REGISTER_DMA:=False;
 QEMUVPB_REGISTER_UART0:=True;
 QEMUVPB_REGISTER_UART1:=False;
 QEMUVPB_REGISTER_UART2:=False;
 QEMUVPB_REGISTER_UART3:=False;
 QEMUVPB_REGISTER_RTC:=False;
 QEMUVPB_REGISTER_CLOCK:=False;
 QEMUVPB_REGISTER_MMC0:=False;
 QEMUVPB_REGISTER_MMC1:=False;
 QEMUVPB_REGISTER_NETWORK:=False;
 QEMUVPB_REGISTER_KEYBOARD:=False;
 QEMUVPB_REGISTER_MOUSE:=False;
 QEMUVPB_REGISTER_FRAMEBUFFER:=False;
 QEMUVersatilePBInit;
